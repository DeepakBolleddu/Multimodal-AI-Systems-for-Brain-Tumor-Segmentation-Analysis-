...
# -------------------- Paths --------------------
DATA_ROOT = "/g/data/ii16/Image/BrainTumorSeg/Inf_Result/PIFNet_crf_sweep/PIFNet_subsample/"
OUT_ROOT  = "/g/data/ii16/Image/BrainTumorSeg/Inf_ResultPIFNet_crf_sweep/PIFNet_crf_validation_5_2_3_12_12_5/"
...
DEFAULTS = dict(
    data_root=DATA_ROOT,
    out_root=OUT_ROOT,
    crf_iters=5, sxy_g=2, compat_g=3, sxy_b=12, srgb_b=12, compat_b=5
)
